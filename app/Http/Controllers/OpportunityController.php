...
class OpportunityController extends Controller
{
    ...
    public function show(string $slug)
    {
        ...
        $formatted = [
            ...
            'content' => $this->markdownToHtml($opportunity->content),
            ...
            'benefits' => $this->markdownToHtml($opportunity->benefits),
            'eligibility' => $this->markdownToHtml($opportunity->eligibility),
            'required_documents' => $this->markdownToHtml($opportunity->required_documents),
            'application_process' => $this->markdownToHtml($opportunity->application_process),
            'important_notes' => $this->markdownToHtml($opportunity->important_notes),
